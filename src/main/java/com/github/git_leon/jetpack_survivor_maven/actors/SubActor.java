...
public class SubActor extends Actor{
    ...
    public Bullet shoot(int velocity) {
        return (Bullet)addObject(new Bullet(velocity), getX(), getY());
    }

    public Bullet shoot(int velocity, Actor actor) {
        Bullet projectile = (Bullet)addObject(shoot(velocity), getX(), getY());
